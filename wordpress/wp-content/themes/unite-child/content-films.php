...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<?php 
			...
			//die('d');
		?>
		<h5><b>Country</b>: <?php echo implode(', ',$countries);?></h5>
		<h5><b>Genre</b>: <?php echo implode(', ',$genres);?></h5>
		<h5><b>Ticket Price</b>: <?php echo get_field('fticket_price',$post->ID);?></h5> 
		<h5><b>Release Date</b>: <?php echo get_field('frelease_date',$post->ID);?></h5>
	</div><!-- .entry-content -->
	<?php endif; ?>
